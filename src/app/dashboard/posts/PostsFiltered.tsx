...
import { canAutoGenerate } from "@/lib/generate-post-visual"
                  ...
                  return (
                    <div key={post.id}>
                      ...
                      <div className="mt-1.5 ml-1 space-y-1">
                        ...
                        {briefVisuel && (() => {
                          const visualKey = typeof meta?.visual_key === "string" ? meta.visual_key : null
                          return (
                              ...
                              <div>
                                {visualKey ? (
                                  <>
                                    ...
                                    <a
                                      href={`/api/images/${encodeURIComponent(visualKey)}`}
                                      target="_blank"
