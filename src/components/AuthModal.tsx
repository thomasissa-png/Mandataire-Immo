    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full h-12 rounded-full bg-secondary text-white font-display font-bold text-body shadow-sm hover:bg-secondary-600 hover:shadow-md active:scale-[0.97] transition-all duration-normal disabled:opacity-60 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2"
        >
      ...
      <div className="flex items-center gap-3 my-5">
        ...
        <span className="text-caption text-neutral-400">ou</span>
        <div className="flex-1 h-px bg-border" />
      </div>
      ...
      <button
        ...
        className="w-full h-12 rounded-full border border-neutral-300 bg-white text-foreground font-display font-bold text-body shadow-xs hover:bg-neutral-50 hover:shadow-sm active:scale-[0.97] transition-all duration-normal flex items-center justify-center gap-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2"
      >
    ...
    return (
      <>
        ...
        <button
          type="button"
          onClick={onSwitchMode}
          className="w-full h-12 rounded-full bg-secondary text-white font-display font-bold text-body shadow-sm hover:bg-secondary-600 hover:shadow-md active:scale-[0.97] transition-all duration-normal focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2"
        >
          Se connecter
        </button>
      </>
